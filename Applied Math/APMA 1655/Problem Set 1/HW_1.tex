...
\begin{proof}
  We have that \(E_1\cup E_2=A_1\cup A_2 \subset \bigcup_{n=1}^\infty A_n\).
  Let \(x\in\bigcup_{n=1}^\infty A_n\). For some \(A_i\in \{A_n\}^{\infty}_{n=1}\), we have that \(x\in A_i\subset E_1\cup E_2\).
  Thus, \(x\in E_1\cup E_2\implies \bigcup_{n=1}^\infty A_n \subset E_1\cup E_2\), completing the double inclusion. Therefore,
